    ...
    async search(query, options) {
        ...
        try {
            ...
            while (fetched < totalToFetch) {
                ...
                let searchUrl = `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${encodeURIComponent(query)}&type=video&order=relevance&maxResults=${batchSize}&key=${apiKey}`;
                if (pageToken) {
