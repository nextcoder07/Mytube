...
const search = async (req, res, next) => {
    try {
        ...
        const limit = req.query.limit ? Math.max(parseInt(req.query.limit, 10), 25) : 25;
        ...
        const youtubeStatus = youtubeRequested ? providers_1.default.getProvider("youtube")?.getStatus?.() : undefined;
